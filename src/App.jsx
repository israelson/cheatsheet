...
const INITIAL_COMMANDS = [
  ...
  {id:308,title:"State Show",category:"Terraform",tags:["medium"],command:"terraform state show {USER}",desc:"Exibe detalhes de um recurso no state"},
  ...
  {id:311,title:"Import",category:"Terraform",tags:["high"],command:"terraform import {USER} {PASS}",desc:"Importa recurso existente para o state"},
  ...
  {id:315,title:"Refresh",category:"Terraform",tags:["medium"],command:"terraform refresh",desc:"Sincroniza o state com a infraestrutura real"},
  ...
  // Ansible
  {id:320,title:"Ping Todos os Hosts",category:"Ansible",tags:["medium"],command:"ansible all -i inventory.yml -m ping",desc:"Testa conectividade SSH com todos os hosts"},
